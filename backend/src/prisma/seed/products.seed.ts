import { PrismaClient, IngredientCategory, MeasurementUnit, Product, ProductIngredient, Ingredient } from '@prisma/client';
...
const products: productData[] = [
    ...
    },
    {
        ...
        freeExtrasCategory: [],
        ingredients: [
            { name: 'Chocolate Cake', quantity: 1, unit: MeasurementUnit.PIECE }
        ],
        options: [
            {
                name: 'Ice Cream',
                ...
                choices: [
                    {
                        name: 'Vanilla',
                        priceModifiers: [],
                        ingredients: [{name: 'Vanilla Ice Cream', quantity: 0.125, unit: MeasurementUnit.LITER}]
                    },
                    {
                        name: 'Chocolate',
                        priceModifiers: [],
                        ingredients: [{name: 'Chocolate Ice Cream', quantity: 0.125, unit: MeasurementUnit.LITER}]
                    },
                    {
                        name: 'Strawberry',
                        priceModifiers: [],
                        ingredients: [{name: 'Strawberry Ice Cream', quantity: 0.125, unit: MeasurementUnit.LITER}]
                    }
    ...
    },
    {
        ...
        freeExtrasCategory: [],
        ingredients: [
            { name: 'Apple Pie', quantity: 1, unit: MeasurementUnit.PIECE }
        ],
        options: [
            {
                name: 'Ice Cream',
    ...
    },
    {
        ...
        freeExtrasCategory: [],
        ingredients: [
            { name: 'Tiramisu', quantity: 1, unit: MeasurementUnit.PIECE }
        ],
    },
    {
        name: 'Fanta',
                ...
                for (const choice of option.choices) {
                    await prisma.optionChoice.create({
                        data: {
                            ...
                            name: choice.name,
                            priceModifier: choice.priceModifiers.length > 0 
